...
class CelebA(Imdb):
	...
	def evaluate(self, res):
		""" Perform evaluations: test classificaiton accuracy. """
		
		# res = {'image_list': image_list, 'attr_pred': attr_pred}
		# To allow quick testing on a smaller subset, report the accuracy in terms of the
		# images with reported results. In cases where the reporting set is a proper subset, 
		# should issue a reminder to avoid mistakenly feeding in wrong data.

		# Do people usually use mAP, or do they simply report classification error rate? 
		#  If everything is binary, how do people choose the threshold?	
		pass
